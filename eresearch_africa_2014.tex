...
\pgfdeclareimage[width=0.8\textwidth]{ceph-deployment}{images/ceph_cluster.png}
\begin{frame}
\frametitle{Ceph deployment}
\pgfuseimage{ceph-deployment}
\end{frame}
...
\pgfdeclareimage[width=0.8\textwidth]{glusterfs-deployment}{images/glusterfs_cluster.png}
\begin{frame}
\frametitle{GlusterFS deployment}
\pgfuseimage{glusterfs-deployment}
\end{frame}
